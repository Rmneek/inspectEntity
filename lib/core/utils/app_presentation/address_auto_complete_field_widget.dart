...
import 'package:inspect_connect/core/utils/app_enums/address_field_style.dart';
  ...
  void _initializePlaces() {
    try {
      if (widget.googleApiKey.isNotEmpty) {
        ...
        throw Exception(googlePlacesInitFailed);
      }
    } catch (e) {
      _switchToFallback();
    }
  ...
  Future<void> _fetchPlaceDetails(String placeId) async {
    ...
    try {
      ...
      Map<String, String?> components = {
        AppKeywords.city: null,
        AppKeywords.state: null,
        AppKeywords.pincode: null,
        AppKeywords.country: null,
      };
      ...
      widget.onFullAddressFetched?.call({
        AppKeywords.placeName: place.name,
        ...components,
        AppKeywords.latitude: place.latLng?.lat,
        AppKeywords.longitude: place.latLng?.lng,
        AppKeywords.placeType: place.types?.isNotEmpty == true
