    ...
    return Column(
      ...
      children: [
        ...
        AppSection(
          ...
          error: vm.certificateTypeError != null,
          errorMessage: vm.certificateTypeError ?? '',
        ...
        AppSection(
          ...
          error: vm.documentError != null,
          errorMessage: vm.documentError ?? '',
          child: CommonDocumentGrid(
            ...
            onPreview: (index, isNetwork) {
              if (isNetwork) {
                final url = vm.existingDocumentUrls[index];
                openPreview(
                  context,
                  pathOrUrl: url,
                  isImage: isImage(url),
